...
export const hiddenSpots: HiddenSpot[] = [
  ...
  spot({
    slug: "cold-storage-under-shelf",
    name: "Under-Shelf Dark Zone",
    map: "Cold Storage",
    mapSlug: "cold-storage",
    category: "community",
    survivalRate: 74,
    ...
    author: "meccha-chameleon.net",
    submittedAt: "2026-06-22",
    tips: "Seeker should check dark lower shelf after inspecting meat prop row.",
    source: "meccha-chameleon.net",
    sourceUrl: "https://meccha-chameleon.net/maps/cold-storage/",
  }),
  spot({
  ...
  spot({
    ...
    tips: "Body disappears in beam gap if brick color and horizontal striping are close.",
    source: "meccha-chameleon.net",
    sourceUrl: "https://meccha-chameleon.net/maps/best-hiding-spots/",
    featured: true,
  }),
