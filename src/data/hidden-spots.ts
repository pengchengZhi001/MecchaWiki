...
export const hiddenSpots: HiddenSpot[] = [
  ...
  spot({
    ...
    tips: "On the ceiling near the cloud backdrop — sample balloon color before prep ends; finish climb before hunt phase.",
    source: "TheGamer",
    sourceUrl: "https://www.thegamer.com/mecca-chameleon-best-hiding-spots-guide/",
    trending: true,
  }),
  ...
  spot({
    slug: "indoor-country-cow-standee",
    name: "Cow Standee Prop",
    map: "Indoor Country",
    mapSlug: "indoor-country",
    category: "best",
    survivalRate: 81,
    ...
    author: "TheGamer Community",
    submittedAt: "2026-07-01",
    tips: "Perch on a cow standee and sample standee surface — not barn wall behind you. Prop mimic breaks outline on beginner lobbies.",
    source: "TheGamer",
    sourceUrl: "https://www.thegamer.com/mecca-chameleon-best-hiding-spots-guide/",
    featured: true,
    trending: true,
  ...
  spot({
    slug: "indoor-country-fallen-standee",
    name: "Fallen Standee Crouch",
    map: "Indoor Country",
    mapSlug: "indoor-country",
    category: "community",
    survivalRate: 73,
    ...
    author: "TheGamer Community",
    submittedAt: "2026-07-01",
    tips: "Crouch on a toppled standee near horse props — low pose reads as debris, not a player silhouette.",
    source: "TheGamer",
    sourceUrl: "https://www.thegamer.com/mecca-chameleon-best-hiding-spots-guide/",
  }),
  spot({
    slug: "indoor-country-hay-bales-pile",
    name: "Hay Bale Pile",
    map: "Indoor Country",
    mapSlug: "indoor-country",
    category: "best",
    ...
    author: "TheGamer Community",
    submittedAt: "2026-07-01",
    tips: "Paint barn panel behind the hay stack, not hay gold on torso alone — dual-tone barn + straw sells the hide.",
    source: "TheGamer",
    sourceUrl: "https://www.thegamer.com/mecca-chameleon-best-hiding-spots-guide/",
    trending: true,
  }),
  spot({
    slug: "indoor-country-pumpkin-patch",
    name: "Pumpkin Patch Corner",
    map: "Indoor Country",
    mapSlug: "indoor-country",
    category: "community",
    survivalRate: 72,
    ...
    author: "IGN Editor Jen",
    submittedAt: "2026-07-01",
    tips: "Wedge into the pumpkin cluster or mimic fence-line dirt — sample orange face and shadow soil separately.",
    source: "IGN",
    sourceUrl: "https://www.ign.com/wikis/meccha-chameleon/All_Maps_in_Meccha_Chameleon:_Best_Hiding_Spots",
  }),
  ...
  spot({
    ...
    author: "IGN Editor Jen",
    submittedAt: "2026-06-22",
    tips: "Hide inside truck bed or undercarriage — sample shaded metal, not lit asphalt. Shadow paint is critical. Re-verify after v2.5.0 Osaka rework.",
    source: "IGN",
    sourceUrl: "https://www.ign.com/wikis/meccha-chameleon/All_Maps_in_Meccha_Chameleon:_Best_Hiding_Spots",
    featured: true,
    trending: true,
  ...
  spot({
    ...
    author: "IGN Editor Jen",
    submittedAt: "2026-06-22",
    tips: "Blend into overhead signs or the large octopus wall statue. Finish prep before hunt — seekers look up on round two. Re-verify after v2.5.0 Osaka rework.",
    source: "IGN",
    sourceUrl: "https://www.ign.com/wikis/meccha-chameleon/All_Maps_in_Meccha_Chameleon:_Best_Hiding_Spots",
    featured: true,
    trending: true,
  ...
  spot({
    ...
    tips: "Open storefronts with metal fans and crates — sample exact prop surface, not mixed neon mid-tones. Re-verify after v2.5.0 Osaka rework.",
    source: "IGN",
    sourceUrl: "https://www.ign.com/wikis/meccha-chameleon/All_Maps_in_Meccha_Chameleon:_Best_Hiding_Spots",
    trending: true,
  }),
  spot({
    ...
    author: "IGN Editor Jen",
    submittedAt: "2026-06-23",
    tips: "Walled corner with plywood stacks, crates, and trash bags — trash-can mimic or flat bag pose both work. Re-verify after v2.5.0 Osaka rework.",
    source: "IGN",
    sourceUrl: "https://www.ign.com/wikis/meccha-chameleon/All_Maps_in_Meccha_Chameleon:_Best_Hiding_Spots",
    trending: true,
  }),
  spot({
    ...
    tips: "Tight alley geometry breaks silhouette — commit to one wall color and avoid straddling lantern light zones. Re-verify after v2.5.0 Osaka rework.",
    source: "IGN",
    sourceUrl: "https://www.ign.com/wikis/meccha-chameleon/All_Maps_in_Meccha_Chameleon:_Best_Hiding_Spots",
  }),
