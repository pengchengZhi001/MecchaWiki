...
export const maps: GameMap[] = [
  {
    ...
    difficulty: "Easy",
    playerCount: "4–12 PC · Switch 2 host cap 10 after 4.1.1",
    themeColor: "#8B4513",
    accentColor: "#D4A574",
  ...
  },
  {
    ...
    tips: [
      ...
      "Late-September community writeups (note.com): stall undersides, torii post shadows, and planter backs beat plaza-facing rims.",
    ],
    hotspots: [
  ...
  },
  {
    ...
    tips: [
      ...
      "note.com chair-leg meta: gallery benches and plinth undersides get skipped while seekers stare at famous canvases.",
    ],
    hotspots: [
