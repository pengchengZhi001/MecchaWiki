...
const CONTENT: Record<string, WorkshopSeoContent> = {
  ...
  "art-gallery": {
    ...
    tips: [
      ...
      "Increase hunter wait time before rounds — detailed body-paint hides need 60+ seconds of prep.",
      ...
      "Seekers check famous paintings first — rotate to lesser-known frames like Boat Painting beside Monet.",
      "Dark rooms near spawn (Burial at Ornans) forgive value errors — prioritize shadow tones over bright skin.",
      "Spawn-area props (security camera, garbage can) work because hunters sprint toward portrait wings.",
    ],
    ...
    commonMistakes: [
      ...
      "Ignoring the dark Boat Painting next to Impression, Sunrise — hunters assume Monet is enough",
      "Standing in Napoleon cape zone with horse-highlight colors instead of shadow sampling",
    ],
    hotspots: [
      { name: "Mona Lisa & Last Supper Wing", description: "Viral portrait row — high reward but first seeker sweep zone.", type: "hot" },
      { name: "Last Day in Pompeii Room", description: "Furthest from spawn; multiple hiders can stack in one canvas.", type: "hot" },
      { name: "Monet + Boat Painting Pair", description: "Impression, Sunrise draws eyes; darker neighbor canvas is overlooked.", type: "hot" },
      { name: "Spawn Security Camera", description: "Wall-beige body + black head above doorway — non-painting deception.", type: "neutral" },
      { name: "Burial at Ornans Dark Room", description: "Mourner dress tones hide value errors at distance.", type: "neutral" },
      { name: "Napoleon Piano Room", description: "Cape shadow and dim lighting favor patient painters.", type: "neutral" },
    ],
    dangerZones: [
      ...
      { name: "Between Wings", description: "Transition corridors with plain wall beige — no dual-tone cover." },
    ],
    lobbySize: "4–10 players",
    seekerLean: "Hider-favored",
    comments: [
      ...
      { author: "PopuniaFan", text: "Boat Painting beside Monet is free wins if your group only checks the sunrise canvas." },
      { author: "EOS_Host", text: "Everyone must subscribe on Steam before lobby — missing map looks like auth/load failure." },
      { author: "CapeHider", text: "Napoleon room lighting saves sloppy cape sampling. Don't stand in horse highlights." },
    ],
  },
  "the-village": {
