...
export const bestMapsRankedGuide: Guide = {
  ...
  content: [
    ...
    },
    {
      ...
      body: "7) Penguin Hotel — Advanced / v1.2.0 (random elements in v2.7.0 — re-scout props). Ice blues, plush interiors, seeker-favored ballroom. 8) Osaka — Advanced / v1.7.0. IGN: smallest official map — clever positioning required; truck bed, signage height, shop clutter. 9) Egypt — Advanced / v2.7.0, reworked v4.1.0. Desert tomb palette; GameWith Bastet/coffin clutter and uneven walls — re-scout after the rework. 10) HIKAKIN Museum — Medium collab / v2.6.0. Photo walls and exhibit props; lottery default OFF in random mode. 11) Death Burger — Advanced / v2.8.0. Loud carnival signage; boundary paints and prop mimics. 12) Greece — Advanced / v3.0.0, reworked v4.1.0. Santorini blue-white contrast + sunset emissive plays. 13) Garten of Banban — Advanced collab / v3.1.0. Kindergarten murals and signage; lottery may default OFF. 14) Exit 8 — Advanced collab / v3.5.0. Underground corridor from The Exit 8; anomaly chaos zones + looping layout. 15) Deep Sea — Advanced / v3.6.0. Underwater reef with coral, clams, fish, jellyfish, wreck, and treasure chests; open blue water is lethal. 16) Shopping Mall — Advanced / v3.9.0. Bright multi-level atrium; planter/bench, handbag shelf, and floor merchandise piles (GameWith Sep 4). 17) Kyoto — Advanced / v4.1.0. Kyoto Station motif with gardens, torii, maple; open plaza and 大 stair are lethal. 18) Art Museum — Advanced / v4.1.0. Official 美術館; world paintings, in-game exhibits, and miniature dioramas — not Workshop ART GALLERY.",
    },
    {
      id: "expert-tier",
      heading: "Expert — Minimal Forgiveness",
      body: "17) Cold Storage — Expert per site map data. Cold steel gray mandatory; almost no decorative clutter — positioning and shelf shadows do all the work. Warm tones pop instantly. Best for players who already win on Sewer and Backrooms. Kyoto, Art Museum, Shopping Mall, Deep Sea, Exit 8, Greece, Banban, and Death Burger are still being mapped — treat them as advanced learning territory, not ranked staples yet. Re-test Greece and Egypt after the 4.1.0 rework.",
    },
    {
