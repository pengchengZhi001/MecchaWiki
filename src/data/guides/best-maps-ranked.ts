...
export const bestMapsRankedGuide: Guide = {
  ...
  content: [
    ...
    },
    {
      ...
      body: "7) Penguin Hotel — Advanced / v1.2.0 (random elements in v2.7.0 — re-scout props). Ice blues, plush interiors, seeker-favored ballroom. 8) Osaka — Advanced / v1.7.0. IGN: smallest official map — clever positioning required; truck bed, signage height, shop clutter. 9) Egypt — Advanced / v2.7.0, reworked v4.1.0. Desert tomb palette; re-scout pillars after the rework. 10) HIKAKIN Museum — Medium collab / v2.6.0. Photo walls and exhibit props; lottery default OFF in random mode. 11) Death Burger — Advanced / v2.8.0. Loud carnival signage; boundary paints and prop mimics. 12) Greece — Advanced / v3.0.0, reworked v4.1.0. Santorini blue-white contrast + sunset emissive plays. 13) Garten of Banban — Advanced collab / v3.1.0. Kindergarten murals and signage; lottery may default OFF. 14) Exit 8 — Advanced collab / v3.5.0. Underground corridor from The Exit 8; anomaly chaos zones + looping layout. 15) Deep Sea — Advanced / v3.6.0. Underwater reef with coral, clams, fish, jellyfish, and wreck clutter; open blue water is lethal. 16) Shopping Mall — Advanced / v3.9.0. Bright multi-level atrium; planter/bench recess and handbag shelf. 17) Kyoto — Advanced / v4.1.0. Festival atrium with torii, maple, bamboo; open plaza and 大 stair are lethal. 18) Art Museum — Advanced / v4.1.0. Official 美術館; canvas-blend analog, not Workshop ART GALLERY.",
    },
    {
      id: "expert-tier",
