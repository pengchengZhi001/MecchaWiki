...
export const bestMapsRankedGuide: Guide = {
  ...
  content: [
    ...
    },
    {
      ...
      body: "16) Cold Storage — Expert per site map data. Cold steel gray mandatory; almost no decorative clutter — positioning and shelf shadows do all the work. Warm tones pop instantly. Best for players who already win on Sewer and Backrooms. Deep Sea, Exit 8, Greece, Banban, and Death Burger are still being mapped — treat them as advanced learning territory, not ranked staples yet.",
    },
    {
