...
export const mapStrategiesGuide: Guide = {
  ...
  readTime: "18 min",
  excerpt:
    "Rotation fundamentals, danger zone avoidance, and win conditions for core official maps plus v4.1.0 Kyoto / Art Museum.",
  content: [
    {
    ...
    {
      id: "kyoto-art-museum",
      heading: "Kyoto & Art Museum — v4.1.0 Newest Official Pair",
      body: "Kyoto (京都, 18th official) is a Kyoto Station motif (4gamer Aug 31 / GameWith Sep 4): lattice skylight, torii, gardens (庭園), maple balcony, bamboo, wagasa, festival stalls, lantern walls, escalator decks, and a glowing 大 stair. Treat maple / garden / torii / stall clutter as the first dual-sample loop and use vertical volume; skip the polished plaza floor and treat the 大 stair as meme traffic (LEMORION still / Denfaminicogamer / GameWith). Late-September note.com writeups add stall undersides, torii post shadows, planter backs, and escalator undersides — 下・奥・裏. Art Museum (美術館, 19th official): 4gamer lists world-famous paintings plus in-game Meccha objects on display; GameWith adds tourist-attraction miniatures; note.com chair-leg / plinth-underside pins skip canvas-front camps. Do not reuse Workshop ART GALLERY (Popunia) callouts. Greece and Egypt were reworked in the same patch. Full pins: Kyoto and Art Museum map pages plus the hiding-spot database (all experimental until lobby screenshots settle).",
    },
    {
      id: "danger-zones",
      heading: "Danger Zone Avoidance — When Not To Fight",
      body: "Danger zones are map regions where even good color loses to geometry and traffic. Universal rule: do not home in danger zones — cross them or skip them. Mansion ballroom and stair landing, Sewer junction and lit rooms, Backrooms corridors and open office, Penguin Hotel pool and ballroom center, Cold Storage loading bay and aisle crosses, Brick Loft second floor open and window walls, Kyoto plaza floor and 大 stair, Art Museum lit gallery center. Crossing technique: pre-sample at entry wall, lock flat pose, move on seeker back-turn or teammate chase audio, re-sample immediately on exit shadow. If spotted mid-cross, emergency recolor at nearest textured surface then exit zone — do not duel in kill box. Clock endgame sometimes forces danger crossing — choose narrowest angle and shortest path. Seekers farm danger zones for free finds — hiders who respect avoidance win more than hiders who master one hot spot inside a kill box. Mark personal no-fight list per map after three deaths in same zone — usually positioning error masquerading as bad luck. Official map pages on meccha.wiki tag danger zones by name — memorize them per map before you queue ranked-style with friends.",
    },
    {
      id: "win-conditions",
