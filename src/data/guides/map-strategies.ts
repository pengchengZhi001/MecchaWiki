...
export const mapStrategiesGuide: Guide = {
  ...
  content: [
    ...
    },
    {
      ...
      body: "Kyoto (京都, 18th official) is a multi-level indoor festival plaza: lattice skylight, torii rows, maple balcony, bamboo, wagasa, lantern walls, and a glowing 大 stair. Treat maple / torii / bamboo clutter as the first dual-sample loop; skip the polished plaza floor and treat the 大 stair as meme traffic — clip once then rotate (LEMORION still / Denfaminicogamer). Art Museum (美術館, 19th official) has no dedicated still yet — do not reuse Workshop ART GALLERY (Popunia) callouts. Museum analog (skypenguin.net / DualShockers): eyedrop the canvas you touch, prefer darker or lesser-known paintings, compact plinth/frame poses, skip open gallery floors and giant-canvas fronts. Greece and Egypt were reworked in the same patch — re-scout pre-4.1.0 pillar, pit-rim, and alcove pins. Full pins: Kyoto and Art Museum map pages plus the hiding-spot database (all experimental until lobby screenshots settle).",
    },
    {
      id: "danger-zones",
